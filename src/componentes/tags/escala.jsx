    ...
    return (
        <div className="w-4/5 md:w-full flex flex-col :md:flex-row items-center justify-centeri">
            ...
            <div className="w-8/12 md:w-3/5 flex flex-col items-center md:items-start justify-center">
                ...
                <p className="text-center">Estamos en constante evolución junto con las nuevas tecnologías y nuestros programas se actualizan constantemente, sumándosele nuevas herramientas.</p>
            </div>
        </div>
    );
}
