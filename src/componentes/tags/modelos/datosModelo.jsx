...
function DatosModelo(){
    ...
    return (
        <Illustration zoom={1.2} dragRotate={true}>
            <Anchor ref={ref} translate={{y:20}}>
                <Shape stroke={60} color="#c2bcb1" translate={{x:-30}} />
                <Shape closed={false} stroke={10} color="lightblue" path={flecha} />
                <Group>
                    <Box translate={{x:60,y:-5}} width={15} height={30} depth={5} stroke={5} color="tomato" />
                    <Box translate={{x:85,y:-10}} width={15} height={40} depth={5} stroke={5} color="tomato" />
                    <Box translate={{x:110,y:-20}} width={15} height={60} depth={5} stroke={5} color="tomato" />
                </Group>
            </Anchor>
        </Illustration>
    );
