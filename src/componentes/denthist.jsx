...
function Denthist(){
    return (
        ...
        <div style={{height:"240px"}} className="mb-5 md:mb-0 w-6/12 md:w-2/5 flex flex-col items-center justify-end md:justify-center">
            ...
            <h1 className="m-2 w-full text-center text-3xl font-bold">DentHist</h1>
            <p className="m-2 text-sm text-center mb-4">Herramienta administrativa orientada a odontólogos, que lleva un historial clínico dental de los pacientes y un fácil acceso a sus medios de contacto.</p>
            <Link to="/denthist" className="m-auto p-2 border-black border-4 rounded cursor-pointer">Ver más</Link>
            </div>
        </div>
        </div>
    );
